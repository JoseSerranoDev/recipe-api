...
def create_user(email='user@examle.com', password='pass123'):
...
class PrivateIngredientApiTests(TestCase):
    """ Test unauthentiucated API requests. """
    ...
    def test_retrieve_ingredientes(self):
        ...
        Ingredient.objects.create(user=self.user, name='Grape')
    ...
    def test_filtered_ingredients_unique(self):
        """ Tes filtered ingredients returns a unique list. """
